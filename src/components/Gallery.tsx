...
const Gallery = () => {
  ...
  const artworks = [
    ...
    {
      id: 5,
      title: "Variazioni di blu e di rosso",
      category: "colatura",
    ...
    },
    {
      ...
      category: "colatura",
      technique: "Acrilico e cera",
      year: "2015",
      dimensions: "50 × 70 cm",
      price: "€ 1.800",
      available: true,
      image: "/images/WhatsApp Image 2025-07-02 at 14.56.40 (1).jpeg",
      description: "La tecnica della colatura raggiunge qui la sua massima espressione tridimensionale. L'aggiunta di cera crea texture che emergono dalla tela, mentre i flussi cromatici seguono percorsi imprevedibili, generando un'opera che cambia aspetto a seconda dell'angolo di osservazione e della luce."
    },
